...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "olx-pp-cli",
		Short: "Manage olx resources via the olx API",
		Long: `Manage olx resources via the olx API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'olx-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("olx-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'olx-pp-cli profile list')")
